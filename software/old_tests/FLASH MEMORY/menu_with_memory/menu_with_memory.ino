...
#include <DmxInput.h> //                                          https://github.com/jostlowe/Pico-DMX (ORIGINAL)
...
//DMX buffer
  volatile uint8_t buffer[DMXINPUT_BUFFER_SIZE(1, NUM_CHANNELS)];  // CHANGE TO START_CHANNEL //(START_CHANNEL, NUM_CHANNELS)
